...
I downloaded a PDF collection of his work and converted it to a text file. Shiffman helped me with some regex magic to clean up that text file, so that it was only the actual text of the poems (excluding titles). 
...
Here is the [site](https://patchbae.github.io/NerudasTopTen/NerudasTopTen/).
